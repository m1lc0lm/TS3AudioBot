...
namespace NextGenAudio.Helper
{
	public static class WebWrapper
	{
		...
		static WebWrapper()
		{
			...
			ProductInfoHeaderValue version = ProductInfoHeaderValue.TryParse($"NextGenAudio/{Environment.SystemData.AssemblyData.Version}", out var v)
					? v
					: new ProductInfoHeaderValue("NextGenAudio", "1.3.3.7");
