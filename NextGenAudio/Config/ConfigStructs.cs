...
using NextGenAudio.CommandSystem.Text;
...
namespace NextGenAudio.Config
{
	...
	public class ConfConfigs : ConfigTable
	{
		...
		public ConfigValue<bool> SendStats { get; } = new ConfigValue<bool>("send_stats", true,
			...
			"If you want to check how a stats packet looks like you can run the bot with 'NextGenAudio --stats-example'.\n" +
			"To disable contributing without config you can run the bot with 'NextGenAudio --stats-disabled'. This will ignore the config value.");
	}

	public class ConfDb : ConfigTable
	{
		public ConfigValue<string> Path { get; } = new ConfigValue<string>("path", "NextGenAudio.db",
	...
	public partial class ConfBot : ConfigTable
	{
		...
		public ConfigValue<bool> Run { get; } = new ConfigValue<bool>("run", false,
			"Starts the instance when the NextGenAudio is launched.");
	...
	public class ConfConnect : ConfigTable
	{
		...
		public ConfigValue<string> Name { get; } = new ConfigValue<string>("name",
			"NextGenAudio", "Client nickname when connecting.");
	...
	public class ConfAudio : ConfigTable
	{
		...
		public ConfigValue<int> Bitrate { get; } = new ConfigValue<int>("bitrate", 128,
	...
	public class ConfAudioVolume : ConfigTable
	{
		...
		public ConfigValue<float> Default { get; } = new ConfigValue<float>("default", 25);
		public ConfigValue<float> Min { get; } = new ConfigValue<float>("min", 20);
		public ConfigValue<float> Max { get; } = new ConfigValue<float>("max", 25);
	}
